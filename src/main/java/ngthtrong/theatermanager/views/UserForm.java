...
public class UserForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        userBtn.setBackground(new java.awt.Color(255, 10,10));

        userBtn.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N

        userBtn.setForeground(new java.awt.Color(225, 225, 225));
        userBtn.setEnabled(false);

        ListOfUserTable.setBackground(new java.awt.Color(255, 225, 225));
        ListOfUserTable.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ListOfUserTable.setForeground(new java.awt.Color(44, 0, 0));
        ...
        ListOfUserTable.setGridColor(new java.awt.Color(255, 150, 150));
        ListOfUserTable.setRequestFocusEnabled(false);
        ListOfUserTable.setRowHeight(30);
        jScrollPane1.setViewportView(ListOfUserTable);

        addBtn.setBackground(new java.awt.Color(204, 255, 255));
        addBtn.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        addBtn.setText("Add");
        addBtn.setBackground(new java.awt.Color(180, 10,10));
        ...
        saveBtn.setBackground(new java.awt.Color(180, 10,10));
        ...
        getDetailsBtn.setBackground(new java.awt.Color(180, 10,10));

        getDetailsBtn.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N

        getDetailsBtn.setForeground(new java.awt.Color(255, 255, 255));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(emailText, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(fullNameText, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(passwordText, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(rePasswordText, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        cancelBtn.setBackground(new java.awt.Color(180, 10,10));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(58, 58, 58)
                                        .addComponent(getDetailsBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)))))))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(138, 138, 138)
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_saveBtnActionPerformed
        ...
        if (checkIdComplete()) {
            if (passwordText.getText().equals(rePasswordText.getText())) {
                ...
                UserController uc = new UserController();
                uc.setUserForm(this);
                if (uc.checkUsername(userNameText.getText())) {
                    JOptionPane.showMessageDialog(rootPane, "Username is exist");
                    ClearForm();
                    return;
                }
    ...
    public void setTableUserForm(List<User> user) {
        ...
        ListOfUserTable.getColumnModel().getColumn(4)
                .setCellRenderer(ListOfUserTable.getDefaultRenderer(Boolean.class));
    }
    ...
    // java.util.logging.Logger.getLogger(UserForm.class.getName()).log(java.util.logging.Level.SEVERE,
    // null, ex);
    // }
