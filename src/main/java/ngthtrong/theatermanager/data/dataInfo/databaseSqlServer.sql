...
VALUES (1, 'movie 1', 'movie 1', 1, 0);

INSERT INTO movie(movie_id, movie_name, [description], onShowing, commingSoon)
VALUES (2, 'movie 2', 'movie 2', 1, 0);

INSERT INTO movie(movie_id, movie_name, [description], onShowing, commingSoon)
VALUES (3, 'movie 3', 'movie 3', 1, 0);

INSERT INTO movie(movie_id, movie_name, [description], onShowing, commingSoon)
VALUES (4, 'movie 4', 'movie 4', 1, 0);

INSERT INTO movie(movie_id, movie_name, [description], onShowing, commingSoon)
VALUES (5, 'movie 5', 'movie 5', 1, 1);
...
INSERT INTO theater(theater_id, theater_name, isUsing, theater_capacity)
VALUES (3, 'theater 3', 1, 10);

INSERT INTO theater(theater_id, theater_name, isUsing, theater_capacity)
VALUES (4, 'theater 4', 1, 10);

INSERT INTO theater(theater_id, theater_name, isUsing, theater_capacity)
VALUES (5, 'theater 5', 1, 10);

INSERT INTO [period](period_id, period_time, period_size, movie_id, theater_id)
VALUES (1, '2024-11-15 09:30:00', 1, 1, 1);

INSERT INTO [period](period_id, period_time, period_size, movie_id, theater_id)
VALUES (2, '2024-11-15 10:00:00', 1, 2, 2);

INSERT INTO [period](period_id, period_time, period_size, movie_id, theater_id)
VALUES (3, '2024-11-15 10:30:00', 1, 3, 3);

INSERT INTO [period](period_id, period_time, period_size, movie_id, theater_id)
VALUES (4, '2024-11-15 11:00:00', 1, 4, 4);

INSERT INTO [period](period_id, period_time, period_size, movie_id, theater_id)
VALUES (5, '2024-11-15 11:30:00', 1, 5, 5);

INSERT INTO [period](period_id, period_time, period_size, movie_id, theater_id)
VALUES (6, '2024-11-15 12:00:00', 1, 1, 1);
